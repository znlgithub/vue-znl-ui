...
<template>
  <div id="app" :class="{ 'is-component': isComponent }" class="app">
    <main-header v-if="lang !== 'play'"></main-header>
    <div class="main-cnt" :style="mainStyle">
  ...
  export default {
    ...
    methods: {
      suggestJump() {
        ...
        if (href.indexOf('/zh-CN/component/') > -1) return;
        this.$router.push('/zh-CN/component/changelog')
        // setTimeout(() => {
